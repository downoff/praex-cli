export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Praex",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Praex.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Praex.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Praex.",
  ...
  "dialog.plugins.empty": "Plugins configured in praex.json",
  ...
  "dialog.server.description": "Switch which Praex server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Praex",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Praex...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Praex in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Praex...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Praex in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Praex in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Praex",
  "wsl.onboarding.opencodeReadyIn": "Praex is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Praex is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Praex in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Praex",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Praex.",
  ...
  "toast.update.description": "A new version of Praex ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Praex team",
  ...
  "error.chain.checkConfig": "Check your config (praex.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Praex does not support MCP authentication yet.',
  ...
  "home.empty.description": "Open a project to get started",
  "home.title": "Home",
  ...
  "sidebar.gettingStarted.line1": "Praex includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Praex Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Praex server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Praex",
  ...
  "settings.general.row.appearance.description": "Customise how Praex looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Praex follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Praex is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Praex launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Praex.",
