export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Praex",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Praex wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
