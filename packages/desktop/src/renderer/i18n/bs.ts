export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Praex-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Praex-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
