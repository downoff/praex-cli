export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Praex",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Praex. ¿Quieres instalarla y reiniciar?",
