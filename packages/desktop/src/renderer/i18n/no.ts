export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Praex",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Praex er lastet ned. Vil du installere den og starte på nytt?",
