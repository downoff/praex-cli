export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Praex",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Praex a été téléchargée. Voulez-vous l'installer et redémarrer ?",
