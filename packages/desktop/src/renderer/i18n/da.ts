export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Praex",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Praex er blevet downloadet. Vil du installere den og genstarte?",
