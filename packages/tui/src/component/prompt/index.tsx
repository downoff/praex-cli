...
export function Prompt(props: PromptProps) {
  ...
  // The hosted lineup's display names already carry the tier ("Velox II · free"), so the
  // provider name would only repeat "Praex" after it; other providers keep their label.
